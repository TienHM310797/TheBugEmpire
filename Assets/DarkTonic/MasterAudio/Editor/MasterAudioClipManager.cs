...
//            aClip.LoadType = (AudioClipLoadType)EditorGUILayout.EnumPopup(aClip.LoadType, GUILayout.Width(140));
...
//        public AudioInformation(string fullPath, string name, bool is3D, int compressionBitrate, bool forceMono, AudioImporterFormat format, AudioClipLoadType loadType) {
//            OrigIs3D = is3D;
