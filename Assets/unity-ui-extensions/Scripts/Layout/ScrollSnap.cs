...
namespace UnityEngine.UI.Extensions
{
	...
	public class ScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
	{
		...
		public GameObject nvChinh;
		
		public Level level = Level.Leve3;
...
//			if(level == Level.Leve3){
//				if(nvChinh!=null){
//					if(CurrentPage() ==0){
//						iTween.MoveTo (nvChinh, iTween.Hash ("position", new Vector3(-0.5f,-3.2f), "time", 0.5f, "easetype", iTween.EaseType.linear));
//						iTween.ScaleTo (nvChinh, iTween.Hash ("scale", new Vector3(1f,1f), "time", 0.5f, "easetype", iTween.EaseType.linear));
//					}
//					
//					if(CurrentPage() ==1)
//					{	
//
//						iTween.MoveTo (nvChinh, iTween.Hash ("position", new Vector3(-0.8f,-0.15f), "time", 0.5f, "easetype", iTween.EaseType.linear));
//						iTween.ScaleTo (nvChinh, iTween.Hash ("scale", new Vector3(.6f,.6f), "time", 0.5f, "easetype", iTween.EaseType.linear));
//					}
//				}
//			}
